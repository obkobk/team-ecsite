...
public interface MstProductMapper {
	...
	List<MstProduct> findByProductNameKana(@Param("keywords") String[] keywords);
	...
	List<MstProduct> findByCategoryAndProductNameKana(@Param("category") int category, @Param("keywords") String[] keywords);
